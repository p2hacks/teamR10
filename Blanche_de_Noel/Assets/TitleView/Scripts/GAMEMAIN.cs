...
{
    private static int koukando = 4; //好感度のパラメータ
    private static int studyKoukando = -100; // 主人公の勉強パラメータ
    private static int gameKoukando = 2; // 主人公のゲームパラメータ
    private static int sportKoukando = -2; // 主人公のスポーツパラメータ
