...
public class GAMEMAIN : MonoBehaviour
{
    ...
    private static bool studyKoukandoTrigger = false;
    private static bool sportKoukandoTrigger = false;
    private static bool gameKoukandoTrigger = false;
    ...
    {
        if (studyKoukandoTrigger)
        {
            studyKoukando += n;
            studyKoukandoTrigger = false;
        }
    }
    ...
    {
        if (gameKoukandoTrigger)
        {
            gameKoukando += n;
            gameKoukandoTrigger = false;
        }
    }
    ...
    {
        if (sportKoukandoTrigger)
        {
            sportKoukando += n;
            sportKoukandoTrigger = false;
        }
    }

    public static void ResetKoukandoTrigger() => koukandoTrigger = gameKoukandoTrigger = sportKoukandoTrigger = studyKoukandoTrigger = true; //トリガーを元に戻す
}
